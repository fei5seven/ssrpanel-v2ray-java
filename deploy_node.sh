...
install_caddy() {
	...
	if [[ $sys_bit == "i386" || $sys_bit == "i686" ]]; then
		local caddy_download_link="https://github.com/fei5seven/ssrpanel-v2ray-java/raw/master/resource/caddy/1.0.1/caddy_linux_386.tar.gz"
	elif [[ $sys_bit == "x86_64" ]]; then
		local caddy_download_link="https://github.com/fei5seven/ssrpanel-v2ray-java/raw/master/resource/caddy/1.0.1/caddy_linux_amd64.tar.gz"
	else
