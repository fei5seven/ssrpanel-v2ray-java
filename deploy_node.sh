...
install_caddy() {
	...
	if [[ $sys_bit == "i386" || $sys_bit == "i686" ]]; then
		local caddy_download_link="https://github.com/caddyserver/caddy/releases/download/v0.11.5/caddy_v0.11.5_linux_386.tar.gz"
	elif [[ $sys_bit == "x86_64" ]]; then
		local caddy_download_link="https://github.com/caddyserver/caddy/releases/download/v0.11.5/caddy_v0.11.5_linux_amd64.tar.gz"
	else
